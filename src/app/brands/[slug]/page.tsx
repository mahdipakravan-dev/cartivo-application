...
export async function generateMetadata({
  ...
  return {
    ...
    description: `خرید قطعات یدکی ${brand.persianName} (${brand.englishName}) با مقایسه قیمت فروشندگان. مشاهده لیست خودروها و قطعات سازگار.`,
  ...
  const itemListJsonLd = {
    ...
    itemListElement: cars.map((car, index) => ({
      ...
      item: {
        ...
        ...(car.manufactureYear ? { modelDate: String(car.manufactureYear) } : {}),
      },
    })),
  };
