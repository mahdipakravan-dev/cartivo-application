...
export async function generateMetadata({
  ...
  if (isPartId(brandSlug)) {
    ...
    const description = `مشاهده مشخصات و قیمت ${part.name || "قطعه خودرو"}، تضمین اصالت و ارسال سریع از کارتیوُ.`;
    return {
      title,
      description,
  ...
  return (
    <>
      ...
      <main className="bg-[var(--background)] pb-20 pt-24 sm:pt-28">
          ...
          <section className="relative isolate overflow-hidden rounded-[2rem] bg-primary shadow-[0_24px_70px_rgb(15_23_42/0.12)]">
            ...
            <div className="grid min-h-[400px] lg:grid-cols-[1.08fr_.92fr]">
              <div className="relative z-10 flex items-center px-6 py-12 sm:px-10 lg:px-14 lg:py-16">
                <div className="max-w-xl">
                  ...
                  <p className="mt-5 max-w-lg text-sm leading-7 text-white/65 sm:text-base sm:leading-8">
                    مدل خودروی {brand.persianName} خود را انتخاب کنید تا قطعات
                    سازگار را بدون جست‌وجوی اضافه و با اطمینان بیشتری پیدا کنید.
                  </p>
                  ...
                  <div className="mt-8 flex flex-wrap gap-3">
                    ...
                    <a
                      href="#brand-parts"
                      className="inline-flex h-12 items-center gap-2 rounded-xl border border-white/15 bg-white/10 px-5 text-sm font-bold text-white backdrop-blur-sm transition hover:bg-white/15"
                    >
              ...
              <div className="relative hidden min-h-[400px] items-center justify-center overflow-hidden border-r border-white/10 lg:flex">
                ...
                <div className="absolute size-[270px] rounded-full border border-dashed border-accent/15" />
                <div className="absolute size-[210px] rounded-full bg-accent/10 blur-2xl" />
                <div className="relative flex size-52 items-center justify-center rounded-[2.5rem] border border-white/20 bg-white p-8 shadow-2xl shadow-black/25">
                  {brand.iconUrl ? (
                    ...
                    <span
                      dir="ltr"
                      className="text-4xl font-black text-[var(--primary)]"
                    >
        ...
        <section id="brand-cars" className="scroll-mt-24 py-10 sm:py-12">
          <div className="container-cartivo px-4 sm:px-6 lg:px-8">
            <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
              <div>
                <p className="text-xs font-bold text-accent">انتخاب خودرو</p>
                <h2 className="mt-2 text-2xl font-black text-dark sm:text-3xl">
                  خودروهای {brand.persianName}
                </h2>
                <p className="mt-2 text-sm leading-6 text-text-secondary">
                  مدل دقیق خودروی خود را انتخاب کنید تا فقط قطعات سازگار نمایش
                  داده شوند.
                </p>
              </div>
              <div className="flex w-fit items-center gap-2 rounded-xl bg-background px-3.5 py-2.5 text-xs font-bold text-text-secondary">
                <CarFront className="size-4 text-accent" />
            ...
            {cars.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                <div className="flex size-14 items-center justify-center rounded-2xl bg-background">
                  <CarFront className="size-7 text-text-secondary" />
                </div>
                <p className="mt-4 text-sm font-bold text-text-secondary">
                  خودرویی برای این برند یافت نشد
                </p>
                <p className="mt-1 text-xs text-text-secondary">
                  می‌توانید قطعات برند را از بخش بعدی جست‌وجو کنید.
                </p>
              </div>
            ) : (
              <CarsSection
        ...
        <section
          id="brand-parts"
          className="scroll-mt-24 border-t border-border/70 py-10 sm:py-12"
        >
          <div className="container-cartivo px-4 sm:px-6 lg:px-8">
